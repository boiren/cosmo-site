...
const DEMO_PRODUCTS = [
  {
    ...
    category: "arac-bakim",
    price: 1299, oldPrice: 1699, stock: 47, sku: "CT-AB-001",
    badge: "Çok Satan", badgeColor: "blue", featured: true,
    ...
    specs: new Map([["İçerik Adedi","16 parça"],["Garanti","2 yıl"]]),
  },
  {
    ...
    category: "dalis",
    price: 2849, oldPrice: 3499, stock: 12, sku: "CT-DL-001",
    badge: "Sınırlı Stok", badgeColor: "red", featured: true,
    ...
    specs: new Map([["Maks. Derinlik","40 metre"],["Garanti","3 yıl"]]),
  },
  {
    ...
    price: 649, oldPrice: 899, stock: 83, sku: "CT-OK-001",
    badge: "Yeni", badgeColor: "green", featured: true,
    ...
    specs: new Map([["Kapasite","12 Litre"],["Garanti","2 yıl"]]),
  },
  {
    ...
    category: "agiz-bakim",
    price: 479, oldPrice: 649, stock: 156, sku: "CT-AGB-001",
    badge: "Bestseller", badgeColor: "purple", featured: true,
    ...
    specs: new Map([["Pil Ömrü","30 gün"],["Garanti","2 yıl"]]),
  },
]
...
module.exports = async () => {
  try {
    ...
    if (!adminExists) {
      await User.create({
        name: "Cosmo Admin",
        email: process.env.ADMIN_EMAIL || "admin@mihomesanal.com",
        password: process.env.ADMIN_PASSWORD || "Admin123!",
        role: "admin",
      })
      console.log("✅ Demo admin kullanıcısı oluşturuldu")
      console.log(`   E-posta: ${process.env.ADMIN_EMAIL || "admin@mihomesanal.com"}`)
    ...
    if (productCount === 0) {
      ...
      console.log("✅ Demo ürünler oluşturuldu (4 ürün)")
    }
  } catch (err) {
